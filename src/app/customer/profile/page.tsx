      ...
      <Card className="w-full max-w-md shadow-lg">
        <CardHeader>
          <div className="flex items-center gap-4 mb-4">
            ...
            <CardTitle className="font-headline text-3xl text-center flex-1">My Profile</CardTitle>
            <div className="w-8"></div>
          </div>
          <CardDescription className="text-center">Your personal details are safe with us.</CardDescription>
        </CardHeader>
